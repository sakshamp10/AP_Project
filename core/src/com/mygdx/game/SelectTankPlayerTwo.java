...
public class SelectTankPlayerTwo implements Screen {
...
//        renderer.setProjectionMatrix(camera.combined);
        ...
        shapeRenderer.rect(2*viewWidth/3+200,viewHeight/2-500, 250, 100);
        ...
        if (Gdx.input.isTouched()){
            ...
            if (playerTwoRectangle.contains(touchPos.x,  touchPos.y)) {
                if(count == 1){
